...
function RACBFQuadProg(Σ::ControlAffineSystem, P::MatchedParameters, HOCBF::SecondOrderCBF)
    return RACBFQuadProg(Σ, P, [HOCBF])
end

function RACBFQuadProg(Σ::ControlAffineSystem, P::MatchedParameters, k::ACLFQuadProg, HOCBF::SecondOrderCBF)
